    ...
    return (
        <>
            <div className="flex justify-between gap-4 mt-10">
                ...
                <div className="">
                    <h3 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Meet Webnovel</h3>
                    <ul className="border-b">
                        <li className="flex items-center gap-4 border-t mt-5 p-3">
                            ...
                            <img width={64} src="https://flowbite.com/docs/images/carousel/carousel-2.svg" alt="..."/>
                        </li>
                        <li className="flex items-center gap-4 border-t mt-5 p-3">
                            <p className="text-gray-500 dark:text-gray-400">
                                <strong>Lorem ipsum</strong> <br></br> dolor sit amet, consectetur adipisicing elit.
            ...
            <div className="mt-10">
                ...
                <div className="flex gap-[20px]">
                    <div className="rounded-lg flex flex-col gap-4 bg-gray-100">
                        ...
                        <p className="p-5">
                            Lu Wu, an aimless video game developer, had been feeling perturbed ever since he found out
                            he
                            was the direct descendant of a king from the underworld. Other than the title, His
                            Excellency,
                            his ancestor hadn't passed down anything else to him. On top of that, all of his ancestor’s
