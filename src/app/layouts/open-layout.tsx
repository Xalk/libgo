...
export function OpenLayout({ children }: { children?: React.ReactNode }) {
    return (
        <div className="">
            ...
            />
            <main
                className="mx-auto max-w-5xl px-4 sm:px-6 xl:max-w-5xl xl:px-0 flex flex-col justify-between font-sans mt-20">{children}</main>
            <div className="relative bg-cover bg-center bg-fixed bg-[url('https://static.vecteezy.com/system/resources/previews/022/276/247/original/bookshelves-background-generative-ai-free-photo.jpeg')]">
                ...
                <div className="relative z-10 text-center text-white py-16 max-w-3xl mx-auto">
                    ...
                    <p className="text-xl leading-7">
                        This is one of the included Homepage Widgets. Go to the Customizer, click on Widgets and then
